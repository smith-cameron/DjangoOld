...
class Comment(models.Model):
    comment_user = models.ForeignKey(User, related_name = 'comment', on_delete = models.CASCADE)
    comment_message = models.ForeignKey(Message, related_name = 'comment', on_delete = models.CASCADE)
